...
String[] OSCnames = {"/output_1", "/output_2", "/output_3", "/output_4", "/output_5"};
String[] messageNames = {"LEFT JAB", "RIGHT CROSS", "LEFT HOOK", "RIGHT HOOK", "Resting"}; //message names for each DTW gesture type
...
void oscEvent(OscMessage theOscMessage) {
 ...
 for (int i = 0; i < numClasses; i++) {
    if (theOscMessage.checkAddrPattern(OSCnames[i]) == true) {
       showMessage(i);
    }
 }
}
